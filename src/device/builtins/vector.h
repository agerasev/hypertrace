...
#define DECLARE_BUILTIN_VECTOR_CONVERT(S, T, N) \
...
#ifdef DEVICE_DOUBLE
#define DECLARE_BUILTIN_VECTOR_IF_DOUBLE_ENABLED(DEF) DEF
#else
#define DECLARE_BUILTIN_VECTOR_IF_DOUBLE_ENABLED(DEF)
#endif

#define DECLARE_BUILTIN_VECTOR_CONVERT_DST(T, N) \
DECLARE_BUILTIN_VECTOR_CONVERT(uchar, T, N) \
DECLARE_BUILTIN_VECTOR_CONVERT(ushort, T, N) \
DECLARE_BUILTIN_VECTOR_CONVERT(uint, T, N) \
DECLARE_BUILTIN_VECTOR_CONVERT(ulong, T, N) \
DECLARE_BUILTIN_VECTOR_CONVERT(char, T, N) \
DECLARE_BUILTIN_VECTOR_CONVERT(short, T, N) \
DECLARE_BUILTIN_VECTOR_CONVERT(int, T, N) \
DECLARE_BUILTIN_VECTOR_CONVERT(long, T, N) \
DECLARE_BUILTIN_VECTOR_CONVERT(float, T, N) \
DECLARE_BUILTIN_VECTOR_IF_DOUBLE_ENABLED( \
    DECLARE_BUILTIN_VECTOR_CONVERT(double, T, N) \
) \

#define DECLARE_BUILTIN_VECTOR_CONVERT_ALL(N) \
DECLARE_BUILTIN_VECTOR_CONVERT_DST(uchar, N) \
DECLARE_BUILTIN_VECTOR_CONVERT_DST(ushort, N) \
DECLARE_BUILTIN_VECTOR_CONVERT_DST(uint, N) \
DECLARE_BUILTIN_VECTOR_CONVERT_DST(ulong, N) \
DECLARE_BUILTIN_VECTOR_CONVERT_DST(char, N) \
DECLARE_BUILTIN_VECTOR_CONVERT_DST(short, N) \
DECLARE_BUILTIN_VECTOR_CONVERT_DST(int, N) \
DECLARE_BUILTIN_VECTOR_CONVERT_DST(long, N) \
DECLARE_BUILTIN_VECTOR_CONVERT_DST(float, N) \
DECLARE_BUILTIN_VECTOR_IF_DOUBLE_ENABLED( \
    DECLARE_BUILTIN_VECTOR_CONVERT_DST(double, N) \
) \
...
DECLARE_BUILTIN_VECTOR_CONVERT_ALL(2)
DECLARE_BUILTIN_VECTOR_CONVERT_ALL(3)
DECLARE_BUILTIN_VECTOR_CONVERT_ALL(4)
DECLARE_BUILTIN_VECTOR_CONVERT_ALL(8)
DECLARE_BUILTIN_VECTOR_CONVERT_ALL(16)
